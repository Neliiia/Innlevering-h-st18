...
if n%1==0: #sjekker om n er et heltall, altså om resten er null når den deles på 1
    ...
    print("Tallet du skrev inn er ikke et heltall, prøv igjen") #feilmelding hvis n ikke er et heltall52
